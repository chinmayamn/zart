<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="admin_en_gadgets" Title="" Codebehind="en-gadgets.aspx.cs" %>
...
<ul class="navigation">
                ...
                <li><b> Entertainment Gadgets </b></li>
            </ul>	
        	...
        	<div class="in-right">
                    ...
                    <a href="new-arrivals.aspx" >New Arrivals</a>
                     <a href="en-gadgets.aspx" class="select">Entertainment Gadgets</a>
    ...
    <ItemTemplate>
        ...
        <asp:Label ID="Label3" runat="server" Text=<%#Eval("entertainment")%> Visible=false></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
            ...
            <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="75"   >
                ...
                <tr>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Add Entertainment Gadgets" 
