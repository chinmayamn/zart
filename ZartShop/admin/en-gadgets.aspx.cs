...
using ZartDAL;
public partial class admin_en_gadgets : System.Web.UI.Page
{
    admin ad = new admin();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            if (c.Checked == true)
            {
                ad.updateproductview("b", l.Text, "1");
            }
            else if (c.Checked == false)
            {
                ad.updateproductview("b", l.Text, "0");
            }

        }

        msg.Show("Products selected for entertainment gadgets");
    }
