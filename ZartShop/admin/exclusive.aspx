<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="admin_exclusive" Title="" Codebehind="exclusive.aspx.cs" %>
...
<ul class="navigation">
                    ...
                    <a href="new-arrivals.aspx" >New Arrivals</a>
                     <a href="en-gadgets.aspx" >Entertainment Gadgets</a>
                      <a href="hot-offers.aspx" >Hot Offers</a>
                       <a href="exclusive.aspx" class="select">Zart Exclusive</a>
                </div>    
    ...
    <ItemTemplate>
        ...
        <asp:Label ID="Label3" runat="server" Text=<%#Eval("exclusive")%> Visible=false></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
            ...
            <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="75"   >
                ...
                <tr>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Add Zart Exclusive" 
