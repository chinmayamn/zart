...
using ZartDAL;
public partial class admin_exclusive : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            if (c.Checked == true)
            {
                ad.updateproductview("d", l.Text, "1");
            }
            else if (c.Checked == false)
            {
                ad.updateproductview("d", l.Text, "0");
            }

        }

        msg.Show("Products selected for exclusive category");
    }
