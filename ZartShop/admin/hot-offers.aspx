<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="admin_hot_offers" Title="" Codebehind="hot-offers.aspx.cs" %>
...
<ul class="navigation">
        	...
        	<div class="in-right">
                    ...
                    <a href="new-arrivals.aspx" >New Arrivals</a>
                     <a href="en-gadgets.aspx"  >Entertainment Gadgets</a>
                      <a href="hot-offers.aspx" class="select">Hot Offers</a>
    ...
    <ItemTemplate>
        ...
        <asp:Label ID="Label3" runat="server" Text=<%#Eval("hotoffers")%> Visible=false></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
            ...
            <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="75"   >
                ...
                <tr>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Add Hot Offers" 
