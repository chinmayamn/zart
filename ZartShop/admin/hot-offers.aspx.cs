...
using ZartDAL;
public partial class admin_hot_offers : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            if (c.Checked == true)
            {
                ad.updateproductview("c", l.Text, "1");
            }
            else if (c.Checked == false)
            {
                ad.updateproductview("c", l.Text, "0");
            }

        }
        msg.Show("Products selected for hot offers");
    }
