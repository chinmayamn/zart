<%@ Page Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" Inherits="entertainment_gadgets"  Codebehind="entertainment-gadgets.aspx.cs" %>
        ...
        <div class="content">
            ...
            <div class="pros">
                ...
                <ul class="navi">
                	...
                	<li><a href="#" >Entertainment - Gadgets</a> </li>
...
<%--                                       (<%#Eval("counts")%>)--%>
                ...
                <div class="homepro-list">
                    ...
                    <div class="pro-heading">
                    	<h1 class="pro-hline">
                            <asp:Literal ID="Literal3" runat="server"></asp:Literal></h1>
                    ...
                    <div class="p-new">
                        ...
                        <div class="pro-new">
                            ...
                            <div class="pro-dets">
                                ...
                                <asp:Literal ID="Literal1" runat="server" Text=<%#Eval("stext")%>></asp:Literal>
                            </div>
